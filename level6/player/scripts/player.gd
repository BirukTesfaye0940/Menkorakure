...
@export var bullet_scene: PackedScene = preload("res://level6/player/scenes/bullet.tscn")
...
func _on_died() -> void:
	var explosion = preload("res://level6/effects/scenes/explosion.tscn").instantiate()
