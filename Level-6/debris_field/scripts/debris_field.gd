...
@export var RockScene: PackedScene = preload("res://Level-6/debris_field/scenes/rock.tscn")
@export var IceScene: PackedScene = preload("res://Level-6/debris_field/scenes/ice_collectible.tscn")
