...
@export var bullet_scene: PackedScene = preload("res://Level-6/player/scenes/bullet.tscn")
...
func _on_died() -> void:
	var explosion = preload("res://Level-6/effects/scenes/explosion.tscn").instantiate()
